export default {
    ...
    recommended: '',
    nftAirdropRule1: '<div class="flex flex-wrap gap-1 sm:gap-2 text-sm opacity-85"><span class="text-[#FFAC03] font-medium">•</span><span class="text-[#FFAC03] font-medium">50 USD</span> বা <span class="text-[#9945FF] font-medium">0.2 SOL</span> বা <span class="text-[#FFAC03] font-medium">10,000 MINIDOGE</span> দান করুন = 1 NFT এয়ারড্রপ</div>',
