export default {
  ...
  beforeTransferring: "<span class='action-text'>ก่อนการโอน</span>",
  makeSureThat: "<span class='prompt-text'>กรุณายืนยัน</span>",
  disclaimer: "<strong class='disclaimer-title'>มูลนิธิ $MINIDOGE CTO - <i>ข้อจำกัดความรับผิดชอบ</i></strong>",

  fullNotice: "รองรับเฉพาะ <span class='highlight'><i>ที่อยู่กระเป๋าเงินส่วนตัว</i></span> เท่านั้น <span class='text-[#FFAC03]'><i>ห้ามใช้ที่อยู่ของตลาดแลกเปลี่ยน</i></span>",
