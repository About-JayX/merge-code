export default {
  ...
  data: [
    {
      title: "<div class='flex'><b class='text-[#FFAC03]'>1.</b><div class='ml-2'>Buy <i>SOL</i></div></div>",
      text: "You can buy <b>SOL</b> from any major exchange and transfer it to your <i>Phantom wallet</i>.",
      url:""
    },
    {
      title: "<div class='flex'><b class='text-[#FFAC03]'>2.</b><div class='ml-2'>Install <i>Phantom</i></div></div>",
    ...
    {
      title: "<div class='flex'><b class='text-[#FFAC03]'>3.</b><div class='ml-2'>Swap <i>$MINIDOGE</i> on <i>Raydium</i></div></div>",
