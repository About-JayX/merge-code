...
export default {
  ...
  text: [
    ...
    { content: " ay kumakatawan sa pamana ng " },
    { content: "$DOGE", highlight: true },
    { content: ", katulad ng paggabay ni " },
    { content: "Elon Musk", highlight: true },
    { content: " (ang DogeFather) sa kanyang tagapagmana (DogeSon)." }
  ],
  buyUrl: LINKS.BUY.RAYDIUM,
  contractAddressPrefix: "$MINIDOGE",
  contractAddressSuffix: "mula sa pump.fun",
