export default {
  ...
  bindingWarningText2: "Liên kết ngay",
  ownedBy: "Sở hữu bởi",
  ...
  userNameTip:
    "4-60 ký tự, hỗ trợ tiếng Trung, tiếng Anh, số, gạch dưới và dấu trừ",
  ...
  avatar: "Ảnh đại diện",
  bindWallet: {
    title: "Liên kết địa chỉ ví SOL",
    text: "Không thể thay đổi sau khi liên kết thành công",
    solWalletAddress: "Địa chỉ ví SOL",
  },
  confirm: "Xác nhận",
  cancel: "Hủy",
